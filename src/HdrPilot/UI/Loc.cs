...
internal static class Loc
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["entry.hdrEnhance.hint"] = "Upgrades SDR games to HDR. Auto HDR is set in the Windows graphics settings (requires the path); if Auto HDR is off globally, HDR Pilot turns it on while the game is running and restores it afterwards. RTX HDR is set in the game's NVIDIA driver profile (requires an RTX GPU); fine-tuning stays in the NVIDIA app.",
